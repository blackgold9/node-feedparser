 ...
 *
 * Example:
 *    feedparser.on('article', function (article){ // do something });
 *    feedparser.parseStream(fs.createReadStream('file.xml')[, callback]);
 *    // or
 *    fs.createReadStream('file.xml').pipe(feedparser.stream);
 *
 *
 * See parseString for more info.
 *
